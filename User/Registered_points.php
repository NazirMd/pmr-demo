...
$query = "SELECT Point_Name,Food_Type,Point_Address,Longitude, Latitude,City from tbl_registered_points where Country like '$Country' and City in ($DidstrictNames) ";
}
else 
{	
...
$query = "SELECT Point_Name,Food_Type,Point_Address,Longitude, Latitude,City from tbl_registered_points where Country like '$Country' and City in  ($DidstrictNames) and Food_Type like '%$FoodType%' ";
}
