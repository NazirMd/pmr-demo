...
<script src="js/fp_form_validate.js" type="text/javascript"></script>
...
<br>
<P class="text-center"><strong>FORGOT PASSWORD</strong></p>
<hr class="hrstyle">
<form id="fp_form" class="form-horizontal" role="form" action="admin_forgot_password_success.php" method="post">
<div class="form-group">
<div class="col-sm-12">
<input type="email" class="form-control" id="admin_user_name" name="admin_user_name" placeholder="Enter Registered Email">
</div>
</div>

<div class="form-group text-center">
<div class="col-sm-12">
<button type="submit" class="btn btn-primary" id="frlogin" name="frlogin">SUBMIT</button>
