...
<script src="js/jquery.validate.js"></script>
    ...
    ?>    
        ...
        <div class="container register_form mainpanel1" style="margin-top: 150px;" >
             
             <div class="col-lg-12">
                 
                 <div class="col-md-12 text-center">
                     <h2>Admin profile is updated successfully.</h2>
                     
                     <a href="admin_operations.php" class="btn btn-primary">ADMIN PAGE</a>        
                 </div>
</div>
