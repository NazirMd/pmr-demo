...
$result = $menulist->GetPendingOrders($PIDValue);

if(isset($_POST['sortdesc']))
{
$result = $menulist->readPendingOrderListDesc($PIDValue);
}
if(isset($_POST['sortpricedesc'])) {
$result = $menulist->readPendingOrderListPriceDesc($PIDValue);
}
if(isset($_POST['sortpriceasc'])) {
$result = $menulist->readPendingOrderListPriceAsc($PIDValue);
}
if(isset($_POST['sortordername'])) {
$result = $menulist->readPendingOrderListOrderNameAsc($PIDValue);
}
    ...
    <div class="container mainpanel1">        
      ...
      <div class="row"><div class="col-lg-12">        
        <legend class="form_header" style="padding-top: 5px; padding-bottom:  10px;">
            <center><h3>Pending Order List</h3></center></legend>
    </div></div> 
        ...
        <h3>There are no pending orders available</h3>
        </div>
        </div>
        <?php   
        }
...
<button class="btn btn-primary" name="sortordername">Sort by Order Name</button>
