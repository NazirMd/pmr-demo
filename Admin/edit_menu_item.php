...
$MenuItemNumber=$_POST['MenuItem_Id'];

include_once './Logging.php';
include_once './Db_Operations.php';

$MenuItem1 = new Db_Operations();

$result = $MenuItem1->EditMenuItemData($EmailIdValue);
...
$result2=$MenuItem1->EditMenuItemDataByNumber($MenuItemNumber);
...
while($row  = mysqli_fetch_assoc($result2)){
    ...
    $vImage=$row['vImage'];
    $Menu_Order_type=$row['Menu_Order_type'];
...
<script src="js/edit_menu_item.js" type="text/javascript"></script>
...
<body>
    ...
    <div class="container register_form mainpanel1">
        ...
        <legend class="form_header" style="padding-top: 5px; padding-bottom:  10px;">
            <center><h3>Edit Menu Item</h3></center></legend>
    </div></div>
        <div class="row">
            
            <div class="col-lg-12">

                <form class="well form-horizontal register_form" action="edit_menu_item_process.php" method="post" enctype="multipart/form-data" id="edit_menu_item_form">
                <div class="col-md-6">
...
<div class="input-group">
    <input  name="menu_item_name" placeholder="Menu item name" class="form-control input"  type="text" value="<?php echo $MenuItem ?>">
</div>
</div>
</div>
...
<div class="col-md-6">
<div class="input-group">
    <input  name="menu_item_price" placeholder="Menu item price" class="form-control input"  type="text" value="<?php echo $PriceValue ?>">
</div>
</div>
</div>
...
<!--<select name="menu_item_type" class="form-control selectpicker">
<option value="Select Menu item type">Please select Menu item type</option>
...
<label><input type="checkbox" value="All" name="menuitemcheck4" id="menuitemcheck4">All</label>
    ...
    <div id="itemcheck" style="display: hide; font-weight:600;">Please select at least one menu item</div>   
                ...
                <div class="form-group">
<label class="col-md-6 control-label ">Menu Item Image</label>
...
<div class="input-group">
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) 
            {
                ...
                //$('#filesToUpload').val('UPDATE PHOTO');
                $('#filesToUpload').hide();
            };
...
<img id="blah2" src="<?php echo $vImage?>" alt="upload image"  class="img-responsive img-rounded" style="display: compact; width: 250px; height: 150px;" />
...
<!-- ############# End of display upload button instead of choose file control ################# -->
       ...
       <input type="button" value="REPLACE PHOTO" name="" id="filesToUpload"  class="btn btn-primary ">
...
<div class="input-group">
    <input  name="point_city"  class="form-control input"  type="text" value="<?php echo $City ?>" readonly="true">
              ...
              <input type="hidden" value="<?php echo $MenuItemNumber; ?>" name="MenuItemNumber" id="MenuItemNumber">
              <input type="hidden" value="<?php echo $vImage; ?>" name="vImageName" id="vImageName">
              <input type="hidden" value="<?php echo $Menu_Order_type; ?>" name="Menu_Order_type" id="Menu_Order_type">
