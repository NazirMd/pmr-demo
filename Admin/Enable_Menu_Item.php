...
$result = $menulist->EnablereadMenuList($PIDValue);
if(isset($_POST['sortdesc']))
{
$result = $menulist->EnablereadMenuListDescId($PIDValue);
}
if(isset($_POST['sortpricedesc'])) {
$result = $menulist->EnablereadMenuListDescPrice($PIDValue);
}
if(isset($_POST['sortpriceasc'])) {
$result = $menulist->EnablereadMenuListAscPrice($PIDValue);
}
if(isset($_POST['sortmenuitemname'])) {
$result = $menulist->EnablereadMenuListAscName($PIDValue);
}
...
<script src="js/enablemodal.js" type="text/javascript"></script>
</head>
<body>
<?php
...
<center><h3>Enable Menu Item</h3></center></legend>
</div>
</div>
...
<div class="col-lg-12">
    <form action="Enable_Menu_Item.php" method="post">
...
<td>
<a class="enable_menu btn btn-success" data-menu-id="<?php echo $row['MenuItem_Id']; ?>" href="javascript:void(0)">
Enable
</a>
</td>
</tr>
